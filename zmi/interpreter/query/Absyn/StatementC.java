...
public class StatementC extends Statement {
  ...
  public <R,A> R accept(interpreter.query.Absyn.Statement.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof interpreter.query.Absyn.StatementC) {
      interpreter.query.Absyn.StatementC x = (interpreter.query.Absyn.StatementC)o;
