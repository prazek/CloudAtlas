...
public class ProgramC extends Program {
  ...
  public <R,A> R accept(interpreter.query.Absyn.Program.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof interpreter.query.Absyn.ProgramC) {
      interpreter.query.Absyn.ProgramC x = (interpreter.query.Absyn.ProgramC)o;
