...
public abstract class BoolExpr implements java.io.Serializable {
  ...
  public interface Visitor <R,A> {
    public R visit(interpreter.query.Absyn.BoolExprCmpC p, A arg);
    public R visit(interpreter.query.Absyn.BoolExprRegExpC p, A arg);
    public R visit(interpreter.query.Absyn.BoolExprBasicExprC p, A arg);
