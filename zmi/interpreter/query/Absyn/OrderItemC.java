...
public class OrderItemC extends OrderItem {
  ...
  public <R,A> R accept(interpreter.query.Absyn.OrderItem.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof interpreter.query.Absyn.OrderItemC) {
      interpreter.query.Absyn.OrderItemC x = (interpreter.query.Absyn.OrderItemC)o;
